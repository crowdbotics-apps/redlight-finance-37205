...
## Project Structure
    ...
    ├── redlight_finance_37205  # Django project configurations
...
1. Clone this repo and `cd redlight_finance_37205`
...
2. Clone this repo and `cd redlight_finance_37205`
